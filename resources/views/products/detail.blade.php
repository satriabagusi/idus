       ...
       <div class="col-4">
        ...
        <div class="col-5">
            ...
            <div class="form-inline justify-content-between">
                ...
                <button class="btn btn-info text-center btn-sm" data-toggle="modal" data-target="#loginModal"><i class="fas fa-cart-plus mr-1"></i> Add to Cart</button>
            </div>
            <a href="#" class="btn btn-danger mt-2 btn-block" data-toggle="modal" data-target="#loginModal">Beli Sekarang</a>
            @else
